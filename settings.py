...
DATABASES = {
    'default': {
        ...
        'NAME': 'writenow',                      # Or path to database file if using sqlite3.
        'USER': 'root',                      # Not used with sqlite3.
        'PASSWORD': 'Pryth1ian',                  # Not used with sqlite3.
...
SECRET_KEY = '*4hh7-hawa_zz_wq!kmgw)+do2otr!f4+u4$f)3^y=*4de$i%1'
